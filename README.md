...
## 🚀 Why I built this
I wanted to challenge myself to write clean, modular logic for a game that feels fun and responsive. Instead of just a simple script, I focused on making the user experience intuitive—ensuring the game is easy to understand and handles input errors gracefully.
